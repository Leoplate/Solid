...
namespace primer_parcial_solid_transporte
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            TransporteRepository rep1 = new TransporteRepository();
            rep1.guardar(avion1);
            ...
            TransporteRepository rep2 = new TransporteRepository();
            rep2.guardar(avion2);
            ...
            TransporteRepository rep3 = new TransporteRepository();
            rep3.guardar(tren1);
